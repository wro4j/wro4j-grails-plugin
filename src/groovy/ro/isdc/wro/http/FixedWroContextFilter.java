...
/** This is a copy of ro.isdc.wro.http.FixedWroContextFilter with a fix for https://code.google.com/p/wro4j/issues/detail?id=824
 * This class should be removed when that bug is fixed
 * @author candrews
 *
 */
public class FixedWroContextFilter
  implements Filter {
